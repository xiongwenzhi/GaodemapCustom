package com.android.orangetravel.ui.widgets.citypicker.view;
...
public class SideIndexBar extends View {
    ...
    private void init(Context context) {
        ...
        mTextTouchedColor = context.getResources().getColor(R.color.cp_colorPrimaryDark);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mItemHeight = (int) ((mHeight / mIndexItems.size()) / 1.5);
        mTopMargin = (mHeight - mItemHeight * mIndexItems.size()) / 3;
    }
