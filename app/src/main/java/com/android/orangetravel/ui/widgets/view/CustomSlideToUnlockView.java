...
public class CustomSlideToUnlockView extends RelativeLayout {
    ...
    private TextView tv_right;//右边文字
    ...
    private void init(TypedArray mTypedArray) {
        ...
        slideImageViewWidth = (int) mTypedArray.getDimension(R.styleable.SlideToUnlockView_slideImageViewWidth, DensityUtil.dp2px(50));
    ...
    public void setBgResource(int bgResource) {
        rl_slide.setBackgroundResource(bgResource);//rootView设置背景
        rl_root.setBackgroundResource(bgResource);//rootView设置背景
    }
    ...
    protected void initView() {
        ...
        tv_hint.setTextSize(DensityUtil.sp2px(textSize));
        tv_hint.setTextColor(textColorResId);
        tv_hint.setText(TextUtils.isEmpty(textHint) ? "到达上车地点" : textHint);
...
//                        }
    ...
    //设置右边文字
    public void setTv_right(String tv_value) {
        tv_right.setText(tv_value);
    }
