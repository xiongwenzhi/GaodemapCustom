 ...
 * @author yangfei
 */
public class YangThemeTitleBar extends FrameLayout {

    public YangThemeTitleBar(@NonNull Context mContext) {
        super(mContext);
    }

    public YangThemeTitleBar(@NonNull Context mContext, @Nullable AttributeSet attrs) {
    ...
    private void initView(final Context mContext, AttributeSet attrs) {
        /*添加布局文件*/
        LayoutInflater.from(mContext).inflate(R.layout.common_title_theme_bar, this);
