...
import com.android.orangetravel.base.widgets.dialog.action.ActivityAction;
import com.android.orangetravel.base.widgets.dialog.action.AnimAction;
import com.android.orangetravel.base.widgets.dialog.action.ClickAction;
import com.android.orangetravel.base.widgets.dialog.action.HandlerAction;
import com.android.orangetravel.base.widgets.dialog.action.ResourcesAction;
 ...
 *    desc   : Dialog 基类
 */
public class BaseUIDialog extends AppCompatDialog implements LifecycleOwner,
    ...
    private final ListenersWrapper<BaseUIDialog> mListeners = new ListenersWrapper<>(this);
    private final LifecycleRegistry mLifecycle = new LifecycleRegistry(this);

    private List<BaseUIDialog.OnShowListener> mShowListeners;
    private List<BaseUIDialog.OnCancelListener> mCancelListeners;
    private List<BaseUIDialog.OnDismissListener> mDismissListeners;

    public BaseUIDialog(Context context) {
        this(context, R.style.BaseDialogStyle);
    }

    public BaseUIDialog(Context context, @StyleRes int themeResId) {
    ...
    public int getWindowAnimations() {
        ...
        return BaseUIDialog.ANIM_DEFAULT;
    }
     ...
     * @deprecated           请使用 {@link #addOnShowListener(BaseUIDialog.OnShowListener)}}
     */
    @Deprecated
    @Override
     ...
     * @deprecated           请使用 {@link #addOnCancelListener(BaseUIDialog.OnCancelListener)}
     */
    @Deprecated
    @Override
     ...
     * @deprecated           请使用 {@link #addOnDismissListener(BaseUIDialog.OnDismissListener)}
     */
    @Deprecated
    @Override
     ...
     * @deprecated           请使用 {@link #setOnKeyListener(BaseUIDialog.OnKeyListener)}
     */
    @Deprecated
    @Override
    ...
    public void setOnKeyListener(@Nullable BaseUIDialog.OnKeyListener listener) {
     ...
     */
    public void addOnShowListener(@Nullable BaseUIDialog.OnShowListener listener) {
     ...
     * @param listener      监听器对象
     */
    public void addOnCancelListener(@Nullable BaseUIDialog.OnCancelListener listener) {
     ...
     * @param listener      监听器对象
     */
    public void addOnDismissListener(@Nullable BaseUIDialog.OnDismissListener listener) {
     ...
     * @param listener      监听器对象
     */
    public void removeOnShowListener(@Nullable BaseUIDialog.OnShowListener listener) {
        if (mShowListeners != null) {
     ...
     * @param listener      监听器对象
     */
    public void removeOnCancelListener(@Nullable BaseUIDialog.OnCancelListener listener) {
        if (mCancelListeners != null) {
     ...
     * @param listener      监听器对象
     */
    public void removeOnDismissListener(@Nullable BaseUIDialog.OnDismissListener listener) {
        if (mDismissListeners != null) {
     ...
     * 设置显示监听器集合
     */
    private void setOnShowListeners(@Nullable List<BaseUIDialog.OnShowListener> listeners) {
        super.setOnShowListener(mListeners);
     ...
     * 设置取消监听器集合
     */
    private void setOnCancelListeners(@Nullable List<BaseUIDialog.OnCancelListener> listeners) {
        super.setOnCancelListener(mListeners);
     ...
     * 设置销毁监听器集合
     */
    private void setOnDismissListeners(@Nullable List<BaseUIDialog.OnDismissListener> listeners) {
        super.setOnDismissListener(mListeners);
    ...
    public static class Builder<B extends Builder> implements LifecycleOwner, ActivityAction, ResourcesAction, ClickAction {
        ...
        /** 动画样式 */
        private int mAnimStyle = BaseUIDialog.ANIM_DEFAULT;
        /** 重心位置 */
        ...
        /** Dialog Show 监听 */
        private List<BaseUIDialog.OnShowListener> mOnShowListeners;
        /** Dialog Cancel 监听 */
        private List<BaseUIDialog.OnCancelListener> mOnCancelListeners;
        /** Dialog Dismiss 监听 */
        private List<BaseUIDialog.OnDismissListener> mOnDismissListeners;
        /** Dialog Key 监听 */
        private BaseUIDialog.OnKeyListener mOnKeyListener;

        /** 点击事件集合 */
        private SparseArray<BaseUIDialog.OnClickListener> mClickArray;
         ...
         * 添加显示监听
         */
        public B addOnShowListener(@NonNull BaseUIDialog.OnShowListener listener) {
            if (isCreated()) {
         ...
         * 添加取消监听
         */
        public B addOnCancelListener(@NonNull BaseUIDialog.OnCancelListener listener) {
            if (isCreated()) {
         ...
         * 添加销毁监听
         */
        public B addOnDismissListener(@NonNull BaseUIDialog.OnDismissListener listener) {
            if (isCreated()) {
         ...
         * 设置按键监听
         */
        public B setOnKeyListener(@NonNull BaseUIDialog.OnKeyListener listener) {
            if (isCreated()) {
         ...
         * 设置点击事件
         */
        public B setOnClickListener(@IdRes int id, @NonNull BaseUIDialog.OnClickListener listener) {
            if (isCreated()) {
        ...
        public BaseUIDialog create() {
            ...
            if (mAnimStyle == BaseUIDialog.ANIM_DEFAULT) {
                switch (mGravity) {
                    case Gravity.TOP:
                        mAnimStyle = BaseUIDialog.ANIM_TOP;
                        break;
                    case Gravity.BOTTOM:
                        mAnimStyle = BaseUIDialog.ANIM_BOTTOM;
                        break;
                    case Gravity.LEFT:
                        mAnimStyle = BaseUIDialog.ANIM_LEFT;
                        break;
                    case Gravity.RIGHT:
                        mAnimStyle = BaseUIDialog.ANIM_RIGHT;
                        break;
                    default:
                        mAnimStyle = BaseUIDialog.ANIM_DEFAULT;
                        break;
                }
            }
         ...
         */
        protected BaseUIDialog createDialog(Context context, @StyleRes int themeId) {
            return new BaseUIDialog(context, themeId);
        }
    ...
    private static final class DialogLifecycle implements
            ...
            BaseUIDialog.OnShowListener,
            BaseUIDialog.OnDismissListener {

        private static void with(Activity activity, BaseUIDialog dialog) {
        ...
        private DialogLifecycle(Activity activity, BaseUIDialog dialog) {
            mActivity = activity;
        ...
        public void onActivityPaused(@NonNull Activity activity) {
            ...
            if (mDialog != null && mDialog.isShowing()) {
                ...
                // 设置 Dialog 无动画效果
                mDialog.setWindowAnimations(BaseUIDialog.ANIM_EMPTY);
            }
        }
        ...
        @Override
        public void onShow(BaseUIDialog dialog) {
            mDialog = dialog;
            registerActivityLifecycleCallbacks();
        }

        @Override
        public void onDismiss(BaseUIDialog dialog) {
            mDialog = null;
            unregisterActivityLifecycleCallbacks();
        }
    ...
    private static final class ViewClickWrapper
        ...
        private final BaseUIDialog mDialog;
        private final BaseUIDialog.OnClickListener mListener;

        private ViewClickWrapper(BaseUIDialog dialog, BaseUIDialog.OnClickListener listener) {
            mDialog = dialog;
            mListener = listener;
        }
    ...
    private static final class ShowListenerWrapper
            ...
            implements BaseUIDialog.OnShowListener {
    ...
    private static final class CancelListenerWrapper
            ...
            implements BaseUIDialog.OnCancelListener {
    ...
    private static final class DismissListenerWrapper
            ...
            implements BaseUIDialog.OnDismissListener {
    ...
    private static final class KeyListenerWrapper
        ...
        private final BaseUIDialog.OnKeyListener mListener;

        private KeyListenerWrapper(BaseUIDialog.OnKeyListener listener) {
            mListener = listener;
        }
        ...
        public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null && dialog instanceof BaseUIDialog) {
                mListener.onKey((BaseUIDialog) dialog, event);
            }
            return false;
        }
    }
    ...
    public interface OnClickListener<V extends View> {
        void onClick(BaseUIDialog dialog, V view);
    }
    ...
    public interface OnShowListener {
         ...
         * Dialog 显示了
         */
        void onShow(BaseUIDialog dialog);
    }
    ...
    public interface OnCancelListener {
         ...
         * Dialog 取消了
         */
        void onCancel(BaseUIDialog dialog);
    }
    ...
    public interface OnDismissListener {
         ...
         * Dialog 销毁了
         */
        void onDismiss(BaseUIDialog dialog);
    }
    ...
    public interface OnKeyListener {
         ...
         * 触发了按键
         */
        boolean onKey(BaseUIDialog dialog, KeyEvent event);
    }
}