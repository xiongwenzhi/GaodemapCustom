package com.android.orangetravel.base.widgets.photopicker.utils;//package com.yang.base.views.photopicker.utils;
//
...
//        try {
//            File cacheDir = OtherUtils.getDiskCacheDir(BaseApp.getAppContext(), "images");
//            if (!cacheDir.exists()) {
//                cacheDir.mkdirs();
//            }
//            mDiskLruCache = DiskLruCache.open(cacheDir, OtherUtils.getAppVersion(BaseApp.getAppContext()), 1, 15 * 1024 * 1024);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//    }
...
//            Bitmap mBitmap = null;
//            mBitmap = tryLoadFromDiskCache(path);
//
//            if (mBitmap == null) {
//                mBitmap = decodeSampledBitmapFromFile(path, params[0], params[1]);
//                BITMAP_CACHE_EXECUTOR.execute(new DiskCacheThread(path, mBitmap));
//            }
//            mPoolSemaphore.release();
//            addBitmapToMemoryCache(path, mBitmap);
//            mBitmap = getBitmapFromMemoryCache(path);
//            return mBitmap;
//        }
//
//        @Override
